...
X = pd.read_csv('War9_X.csv', header=None, sep=';').select_dtypes(include=[np.number]).to_numpy()
Xprime = pd.read_csv('War9_Xprime.csv', header=None, sep=';').select_dtypes(include=[np.number]).to_numpy()
